...
import 'package:tesla_car_animation_part_one/models/TyrePsi.dart';
...
class TyrePsiCard extends StatelessWidget {
          ...
          ? Column(
            crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                Spacer(),
                pisText(context, psi: tyrePsi.psi.toString(),),
  ...
  Text pisText(BuildContext context, {required String psi}) {
    return Text.rich(
      TextSpan(
        text: psi,
        style: Theme.of(context)
